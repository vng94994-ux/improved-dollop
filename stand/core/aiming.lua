...
function Aiming:hookMouse()
    ...
    mt.__index = function(t, k)
        if self.silent and self.state.isPlayable() and (k == "Hit" or k == "Target") and t == Players.LocalPlayer:GetMouse() then
...
function Aiming:onHeartbeat()
    if not self.enabled or not self.state.isPlayable() then return end
